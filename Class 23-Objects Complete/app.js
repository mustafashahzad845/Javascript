...
// cardParent.style.gap = "20px"
// cardParent.style.flexWrap = "wrap"
// // cardParent.style.alignItems = "baseline"
...
// products[i].image.width = "300px"
// products[i].image.height = "300px"
...
// function Std(name , age , email , city) {
// this.name = name , 
// this.age = age , 
//  this.email = email
//  this.city = city
...
// var std1 = new Std("Mustafa" , 15 , "mustafashahzad845@gmail.com")
// var std2 = new Std("Shahzad" , 49 , "shahzad@gmail.com" , "Karachi")
...
var user1 = new Users("Mustafa", "mustafashahzad845@gmail.com", 15)
var user2 = new Users("Muhammad Shafay", "shafay@gmail.com", 17)
...
var usersArr = [
new Users("Muhammad Mustafa", "mustafashahzad845@gmail.com", 15),
new Users("Muhammad Shafay", "shafay@gmail.com", 17),
new Users("Muhammad Ahmed", "shafay@gmail.com", 17),
new Users("Muhammad Mahad", "shafay@gmail.com", 17),
]

for(var values of usersArr){
console.log(values);
